...
def main(args):
    ...
    logs["train_returns"] = np.concatenate(train_returns, axis=0)  # type: ignore
    logs["valid_returns"] = np.concatenate(valid_returns, axis=0)  # type: ignore

    # Print result.npz
    # Print step result (train returns (valid returns))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy", type=str, required=True, help="path to the policy checkpoint")
